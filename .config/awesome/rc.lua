...
-- Errors handling
require("main.errors_check")

-- User variables
mdl.user_vars = require("main.user_vars")
...
-- Initial
terminal    = mdl.user_vars.terminal
editor      = mdl.user_vars.editor
editor_cmd  = terminal .. " -e " .. editor

-- Preference
browser     = mdl.user_vars.brave or user_vars.browser
lock_screen = mdl.user_vars.betterlockscreen
menu        = mdl.user_vars.rofi
...
globalkeys = gears.table.join(
   ...
   awful.key({ }, "XF86MonBrightnessDown", function () 
    ...
    -- Prompt
    awful.key({ modkey }, "space", function () awful.spawn(menu) end,
